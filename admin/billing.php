...
<title>Billing · Bluebookers Admin</title>
...
<main class="property-main" style="max-width:640px; margin:0 auto;">
    <div class="property-heading">
        <p class="property-heading__eyebrow">Permission: billing</p>
        <h1 class="property-heading__title">Billing</h1>
    </div>

    <div class="account-panel account-panel--centered">
        <p>Invoices, payments, and folio management go here next. Staff without the "Billing" permission never see this route — it's hidden from their nav and bounces to Access Denied if they try the URL directly.</p>
    </div>
</main>
