...
<header class="ptopbar">
    ...
    <div class="ptopbar__breadcrumb">
        <span aria-current="page">Reports &amp; Analytics</span>
    </div>
...
<main class="property-main" style="max-width:640px; margin:0 auto;">
    <div class="property-heading">
        ...
        <h1 class="property-heading__title">Reports &amp; Analytics</h1>
    </div>

    <div class="account-panel account-panel--centered">
        <p>Occupancy trends, revenue, and operational reports go here next. Guests never see this route — it bounces straight to Access Denied for the user role.</p>
    </div>
</main>
