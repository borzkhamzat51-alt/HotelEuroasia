...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>1st Floor Plan · Bluebookers</title>
...
<main class="layout-main">
    <div class="property-heading">
        ...
        <div class="floor-switch">
            <a href="layout_1st_floor.php?branch=mtv" class="btn btn--floor btn--active">1st Floor</a>
