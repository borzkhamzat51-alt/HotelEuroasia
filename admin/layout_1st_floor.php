...
// 1st floor: left = 101,102,103 ; right = 104,105,106
...
<html lang="en">
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>1st Floor Plan · Bluebookers</title>
...
<header class="ptopbar">
    ...
    <div class="ptopbar__breadcrumb"><a href="#">Properties</a><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg><span aria-current="page">1st Floor</span></div>
...
<main class="property-main layout-main-override">
    <div class="property-heading">
        ...
        <h1 class="property-heading__title">1st Floor Layout</h1>
        <div style="margin-top:24px; display:flex; justify-content:center; gap:12px; flex-wrap:wrap;">
            <a href="layout_1st_floor.php?branch=mtv" class="btn" style="width:auto; padding:10px 24px; background:var(--blue-500); border:2px solid var(--blue-500); color:var(--white);">1st Floor</a>
