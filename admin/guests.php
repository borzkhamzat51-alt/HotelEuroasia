...
<main class="property-main" style="max-width:640px; margin:0 auto;">
    <div class="property-heading">
        <p class="property-heading__eyebrow">Permission: guests</p>
        <h1 class="property-heading__title">Guests</h1>
    </div>

    <div class="account-panel account-panel--centered">
        <p>Guest profiles, contact details, and stay history across every property go here next. Staff without the "Guests" permission never see this route — it's hidden from their nav and bounces to Access Denied if they try the URL directly.</p>
    </div>
</main>
